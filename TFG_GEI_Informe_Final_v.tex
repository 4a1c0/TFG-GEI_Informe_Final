...
En aquesta secció es descriu en detall cada part del nucli. 
    ...
    En aquesta secció es descriu quins senyals fan falta per operar el nucli i els busos i línies de connexió interns que intercomuniquen les diferents unitats.
        ...
        Els referents a les dades hi ha: valors immediats obtinguts de la instrucció base. En aquest grup s'inclou el valor ``immediate'' que surt directament de la unitat de control. %o el valor de csr\_data que surt de la mateixa unitat de control i arriba a la unitat de CSR
    ...
    *Mostrar esquema de la unitat de control*
    ...
    %A l'hora d'accedir a la memòria de dades l'ISA proporciona diferents mides per llegir i escriure dades (byte, mitja paraula i paraula sencera). Per poder emmascarar correctament les dades i  gestionar les connexions amb la memòria de dades l'utilitza la Unitat de Lectura i Escriptura (LSU). 
